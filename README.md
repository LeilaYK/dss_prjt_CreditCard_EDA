...
- 다른 요일과 비교했을 때 금요일에 20시 이후의 매출이 더 높다.
...
- 12시, 19시에 거래취소가 다른 시간대에 비해 많이 일어나는데 거래가 많이 이뤄지는 시간대이기 때문에 많기 거래취소 빈번하게 일어나는 시간대로 볼 수 있음.  
- 주로 낮에서 저녁 사이의 시간대에 거래 취소가 많은 것을 알 수 있음
